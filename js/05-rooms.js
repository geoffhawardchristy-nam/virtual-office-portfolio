...
function makeRoom(cfg, ctx) {
  ...
  ['back', 'right', 'left'].forEach(side => {
    ...
    if (full) curtainWall(wallRun(side), px, pz, ry, (cfg.mullionAt || {})[side]);
      ...
      spots.forEach(o =>
        stripBay(side === 'back' ? o : px, 2.15, side === 'back' ? pz : o, gw, gh, ry));
    }
  });
